...
- 學科記錄 0–100 分（最多一位小數），術科記錄完成／未完成；學科至少 80 分且術科完成才通過。未登錄保留空白，不視為不合格。家長只看遮罩姓名、合格狀態、術科與檢定結果，不看實際分數。
...
- 挑戰賽維持送分即公開，不受檢定公布按鈕影響。
- 四頁均有「賽事資料首頁」連結至主辦方 Gamma 網站；手機版使用等寬導覽按鈕。
